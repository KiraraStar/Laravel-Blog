...
<head>
    ...
    <meta name="description" content="A personal website page about my recent situation and the latest things I've learned.Sometimes reprint things that interesting">
...
<body>
    <h1 style="display: none">A personal website page about my recent situation and the latest things I've learned.Sometimes reprint things that interesting</h1>
                    ...
                    @foreach($artTop as $at)
                        <div class="like-box-mini">
                            <a href="{{url('/art/'.$at->artId)}}">
                                ...
                                <img class="origin" src="{{asset('/image/loading.gif')}}" data-src="{{asset('/upload/img/'.$at->artImg)}}" onerror="this.src = '{{asset('/image/error.jpg')}}'" alt="info">
                            </a>
                        </div>
                    @endforeach
                </div>
            ...
            @foreach($artInfo as $ai)
                @if($ai->show == 'yes')
                    <article class="article">
                        <div class="art-left">
                            <img class="origin" src="{{asset('/image/loading.gif')}}" data-src="{{asset('/upload/img/'.$ai->artImg)}}" onerror="this.src = '{{asset('/image/error.jpg')}}'" alt="info">
                        </div>
                        <div class="art-right">
                            <div class="show-date">
